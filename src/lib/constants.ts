  ...
  features: [
    {
      ...
      description:
        "Processos planejados para maior agilidade e eficiência entre os seus procedimentos.",
      icon: "timer",
    },
    {
      id: "suporte-tecnico",
      ...
      description:
        "Equipe de enfermagem alinhada ao procedimento e suporte operacional dedicado, do agendamento à alta.",
      icon: "headset",
    },
    {
      id: "ambiente-medico",
  ...
  testimonials: [
    {
      ...
      image: "/assets/images/medicos/alexandre-melo.jpg",
    },
    {
      ...
      image: "/assets/images/medicos/aline-durao.jpg",
    },
    {
      ...
      role: "Médica parceira",
      image: "/assets/images/medicos/rafaela-nicholls.jpg",
    },
    {
...
export const FAQ_DATA = {
  ...
  items: [
    ...
    },
    {
      ...
      answer:
        "Sim. O Hospital São Rafael é um hospital de corpo clínico aberto, o que significa que qualquer médico com registro ativo e em situação regular no conselho pode solicitar credenciamento para realizar procedimentos em nossas instalações, sem a necessidade de vínculo empregatício com o hospital. O processo é conduzido pela nossa equipe de Relacionamento Médico, que avalia o perfil do profissional e alinha as especialidades e protocolos aplicáveis. Uma vez credenciado, o cirurgião conta com 22 salas cirúrgicas equipadas com tecnologia de última geração, equipe de enfermagem dedicada, suporte técnico e um intervalo entre cirurgias planejado para maior agilidade e eficiência. Para iniciar o processo, entre em contato pelo botão \"Falar com Relacionamento Médico\".",
    },
    {
      id: "faq-3",
