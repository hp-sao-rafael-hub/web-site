...
const IMD: ServiceDetailData = {
  ...
  hero: {
    ...
    overlayClassName:
      "bg-gradient-to-t from-charcoal via-charcoal/55 to-transparent lg:bg-gradient-to-r lg:from-charcoal lg:from-10% lg:via-charcoal/65 lg:via-55% lg:to-transparent",
    pills: [
      "14 Especialidades",
      "Consultas e Exames",
      "Laudo em até 24h",
